...
template< class C > class MemBufferT;
...
public:
	...
	ovrLexer( MemBufferT< uint8_t > const & source, char const * punctuation );
...
private:
	...
	void			EmitCodePoint( uint32_t const ch, char * buffer, intptr_t & bufferOfs, size_t const bufferSize,

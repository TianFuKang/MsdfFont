...
#define LOGD(...) LogWithFileTag(ANDROID_LOG_DEBUG,__FILE__ ,__VA_ARGS__) // 定义LOGD类型
#define LOGI(...) LogWithFileTag(ANDROID_LOG_INFO,__FILE__ ,__VA_ARGS__) // 定义LOGI类型
#define LOGW(...) LogWithFileTag(ANDROID_LOG_WARN,__FILE__ ,__VA_ARGS__) // 定义LOGW类型
#define LOGE(...) LogWithFileTag(ANDROID_LOG_ERROR,__FILE__ ,__VA_ARGS__) // 定义LOGE类型
#define LOGF(...) LogWithFileTag(ANDROID_LOG_FATAL,__FILE__ ,__VA_ARGS__) // 定义LOGF类型

#else

#define LOG(...) ( __android_log_print(ANDROID_LOG_INFO,__FILE__ ,__VA_ARGS__)) // 定义LOGI类型
#define WARN(...) ( __android_log_print(ANDROID_LOG_WARN,__FILE__ ,__VA_ARGS__)) // 定义LOGW类型
#define FAIL(...) { __android_log_print(ANDROID_LOG_ERROR,__FILE__ ,__VA_ARGS__);abort(); } // 定义LOGE类型

#define LOG_WITH_TAG( __tag__, ...) ( __android_log_print(ANDROID_LOG_INFO, __tag__ ,__VA_ARGS__) )
#define WARN_WITH_TAG( __tag__, ...) ( __android_log_print(ANDROID_LOG_WARN,__tag__ ,__VA_ARGS__) )
#define FAIL_WITH_TAG( __tag__, ... ) { __android_log_print(ANDROID_LOG_ERROR, __tag__ ,__VA_ARGS__); abort(); }

#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG,__FILE__ ,__VA_ARGS__) // 定义LOGD类型
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO,__FILE__ ,__VA_ARGS__) // 定义LOGI类型
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN,__FILE__ ,__VA_ARGS__) // 定义LOGW类型
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR,__FILE__ ,__VA_ARGS__) // 定义LOGE类型
#define LOGF(...) __android_log_print(ANDROID_LOG_FATAL,__FILE__ ,__VA_ARGS__) // 定义LOGF类型
#endif
...
#define LOGD(...) LogWithFileTag( 0, __FILE__, __VA_ARGS__ )
#define LOGI(...) LogWithFileTag( 0, __FILE__, __VA_ARGS__ )
#define LOGW(...) LogWithFileTag( 0, __FILE__, __VA_ARGS__ )
#define LOGE(...) LogWithFileTag( 0, __FILE__, __VA_ARGS__ )
#define LOGF(...) { LogWithFileTag( 0, __FILE__, __VA_ARGS__ ); exit(0); }
